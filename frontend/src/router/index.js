...
const routes = [
  ...
  { path: '/forget-password', name: 'ForgetPassword', component: () => import('@/views/ForgetPassword.vue'), meta: { public: true } },
  {
    ...
    children: [
      ...
      { path: 'teams/:id/timeline', name: 'TeamTimeline', component: () => import('@/views/team/TeamPostWall.vue'), meta: { title: '动态·时间线' } },
      ...
      { path: 'competitions/awards', name: 'CompetitionAwardBoard', component: () => import('@/views/competition/AwardBoard.vue'), meta: { title: '获奖榜单' } },
      { path: 'competitions/my-registers', name: 'MyCompetitionRegisters', component: () => import('@/views/competition/MyRegisters.vue'), meta: { title: '我的报名' } },
      ...
      { path: 'private-chat', name: 'PrivateChat', component: () => import('@/views/message/PrivateChat.vue'), meta: { title: '私信' } },
      { path: 'evaluations', name: 'EvaluationList', component: () => import('@/views/evaluation/EvaluationList.vue'), meta: { title: '我的评价' } },
